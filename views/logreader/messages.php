				...
				<div class="row-fluid">
					<div class="col-sm-9">
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-lg-4">
										<div class="checkbox">
											<label>
												<input type="checkbox" id="auto-refresh" /> Auto refresh <span class="next-refresh">(Next refresh: <span class="next-refresh-counter"></span>)</span>
											</label>
										</div>
									</div>
								</div>
						...
						<div class="text-center">
							<ul id="messages-pagination" class="pagination">
